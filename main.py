...
def main():
    ...
    imagenes = {
        ...
        "P": pygame.transform.scale(pygame.image.load("imagenes/P(2).png"), (tamaño, tamaño)),
        "T": pygame.transform.scale(pygame.image.load("imagenes/T(2).png"), (tamaño, tamaño)),
        "C": pygame.transform.scale(pygame.image.load("imagenes/C(2).png"), (tamaño, tamaño)),
        "A": pygame.transform.scale(pygame.image.load("imagenes/A(2).png"), (tamaño, tamaño)),
        "Q": pygame.transform.scale(pygame.image.load("imagenes/Q(2).png"), (tamaño, tamaño)),
        "K": pygame.transform.scale(pygame.image.load("imagenes/K(2).png"), (tamaño, tamaño)),
    }
